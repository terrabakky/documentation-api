...
| slack  | `{ "url": "https://hooks.slack.com/services/your-slack-webhook",` <br>`"channel": "#your-channel",` <br>`displayIntroducedBy: false,` <br>`displayResource: false,` <br>`displayTags: false}`   |
